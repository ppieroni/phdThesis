...
% 	\end{figure}
	...
	Con este valor, y a partir de la ecuaci\'on \ref{eq:kup}, se calcul\'o una cota superior al flujo de neutrinos, que aplica en el rango energ\'etico de \cant{\sim1.0\times10^{17}}{eV}-\cant{\sim2.5\times10^{19}}{eV}:
	%
	\begin{equation}
