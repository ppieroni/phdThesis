...
% 	
	...
	Este histograma es el promedio de todas las señales aleatoreas cercanas a \cant{1}{VEM} registradas durante algunos minutos previos al disparo, es decir, es una suerte de señal elemental promedio de la estaci\'on.
...
% 	\end{figure}
	...
	Su valor en este trabajo es $N_{up}=2.39$, que se obtuvo considerando que se observaron 0 eventos candidatos, asumido de manera conservadora 0 eventos de fondo y requiriendo un nivel de confianza de \cant{90\%}{C.L.}.
	...
	\end{equation}
	%
	que aplica en el rango energ\'etico de \cant{\sim1.0\times10^{17}}{eV}-\cant{\sim2.5\times10^{19}}{eV}, en el que se espera haber detectado el \cant{90}{\%} de los eventos.
...
% 	% Kampert & Unger fluxes: Emax=Zx10^20 eV and alpha=2.0
	...
	\begin{enumerate}
	 ...
	 \item Algunos modelos de producci\'on en fuentes astrof\'isicas, como AGN son excluidas con m\~nas del \cant{90\%}{C.L.}.
...
% 	 \item 
	...
	\subsubsection{Comentarios finales de la primera parte}
