...
\label{sc:expoNu}
	...
	Entonces, para obtener las eficiencias de identificación de cada uno de los análisis se consideró una copia del SD de Auger de \cant{50\times50}{km} y se lanzó sobre el centro de la misma las lluvias simuladas y se obtuvo la señal en el detector tal como se explicó en la sección \ref{sc:offline}.
