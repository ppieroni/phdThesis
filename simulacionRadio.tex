...
% 	\clearpage
	...
	Una vez obtenidas las señales en las antenas del detector, es necesario simular su respuesta.
	Para ello, es común modelarlas comon filtro pasa banda. 
	
	\begin{figure}[ht!]
		\centering
		\includegraphics[width=0.8\textwidth]{./fig/simulacionRadio/antennaHEnv}
